...
public class BlueClose2StackOpenGateNoIntake extends AbstractFullAuto {
    @Override
    ...
    protected Action getPathAction() {
        ...
        return drive.actionBuilder(getInitialPose())
                ...
                .strafeToLinearHeading(new Vector2d(9, -36), Math.toRadians(-85))
                .strafeToConstantHeading(new Vector2d(9, -53)) // open gate
                .strafeToSplineHeading(new Vector2d(9, -18), Math.toRadians(-85))  //turn before intake
